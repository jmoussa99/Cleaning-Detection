...
window_indices, cleaning_event_info = extract_cleaning_windows(df, window_size=45)
...
# Combine both approaches: weighted average (50% autoencoder, 50% clustering)
autoencoder_weight = 0.8
